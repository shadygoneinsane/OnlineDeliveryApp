...
public class AccountFragmentUpdatePassword extends Fragment implements View.OnClickListener {
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private TextView fname, lname, mobile;
    private EditText o_password, n_password;
    private Button Submit;
    private boolean flag = false;
    private OnFragmentInteractionListener mListener;

    public AccountFragmentUpdatePassword() {
        // Required empty public constructor
    }

    public static AccountFragmentUpdatePassword newInstance(String param1, String param2) {
        AccountFragmentUpdatePassword fragment = new AccountFragmentUpdatePassword();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View parentView = inflater.inflate(R.layout.fragment_account_update_password, container, false);
        fname = (TextView) parentView.findViewById(R.id.fname_et);
        lname = (TextView) parentView.findViewById(R.id.lname_et);
        //email = (TextView) parentView.findViewById(R.id.email_et);
        mobile = (TextView) parentView.findViewById(R.id.mobileNumber_et);
        o_password = (EditText) parentView.findViewById(R.id.old_password_et);
        n_password = (EditText) parentView.findViewById(R.id.new_password_et);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.Submit_Changes:
                ...
                updateUser(Preferences.getStringPreference(getActivity(), Constants.EMAIL), o_password.getText().toString(), n_password.getText().toString());
                break;
        }
    }

    private void updateUser(final String email, String opassword, String npassword) {

        String urlSuffix = "?email=" + email + "&" + "opassword=" + opassword + "&" + "npassword=" + npassword;
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    URL url = new URL(Constants.BASEURLUPDATEUSERPASSWORD + urlSuffix);
                    Log.v("Url :", " " + url);
